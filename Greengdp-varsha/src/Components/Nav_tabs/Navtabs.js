         ...
         <div className='modi-container inner-nav'>
            <ul className="nav nav-tabs" id="myTab" role="tablist">
                <li className="nav-item" role="presentation">
                    <button className="nav-link active" id="-tab" data-bs-toggle="tab" data-bs-target="#-tab-pane" type="button" role="tab" aria-controls="-tab-pane" aria-selected="true">Importance of Green GDP</button>
                </li>
                <li className="nav-item" role="presentation">
            ...
            <div className="tab-content" id="myTabContent">
                <div className="tab-pane fade show active" id="-tab-pane" role="tabpanel" aria-labelledby="-tab">
                    <ul>
